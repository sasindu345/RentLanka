                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      {user.verificationLevel === 3 && (
                        <span className="inline-flex items-center gap-1 text-xs px-2.5 py-0.5 rounded-full font-medium bg-indigo-950/40 text-indigo-400 border border-indigo-500/20">
