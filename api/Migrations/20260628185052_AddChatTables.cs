        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastMessageContent = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_UserOneId_UserTwoId_ListingId",
                table: "Conversations",
                columns: new[] { "UserOneId", "UserTwoId", "ListingId" },
                unique: true);
