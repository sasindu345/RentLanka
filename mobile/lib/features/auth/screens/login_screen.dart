                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      height:
                          52, // Explicit 52px height matching design guidelines
                      child: FilledButton(
                ...
                Positioned.fill(
                  child: ClipRect(
                    child: BackdropFilter(
                      ...
                      child: Container(
                        color: const Color(0xFFEEF2FF).withOpacity(
                          0.85,
                        ), // Theme-aligned semi-transparent background
                        child: Center(
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
